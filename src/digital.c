...
#define INSTANCIAS_OUTPUT 4
#endif

#ifndef INSTANCIAS_INPUT
#define INSTANCIAS_INPUT 4
#endif
...
digital_input_puntero DigitalInputCreate(uint8_t port, uint8_t pin, bool logic) {
    ...
    if (puntero_entrada) { // si es null no hace nada.
        ...
        Chip_GPIO_SetPinDIR(LPC_GPIO_PORT, puntero_entrada->port, puntero_entrada->pin, false);
    }
...
/// @brief Analiza si tiene logica Negativa o Positiva y devuelve un valor en logica Positiva
/// @param input
/// @return
